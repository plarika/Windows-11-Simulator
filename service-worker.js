"use strict";
const CACHE_NAME="win11-simulator-v9.0.0";
const PRECACHE=[
  "./",
  "./index.html",
  "./favicon.svg?v=8.1.0",
  ...
  "./styles/explorer-sidebar-v870.css?v=9.0.0",
  ...
  "./src/features/explorer-pro-v740.js?v=9.0.0",
  ...
  "./src/features/explorer-columns-v890.js?v=8.9.0",
