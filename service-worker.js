"use strict";
const CACHE_NAME="win11-simulator-v8.1.0";
const PRECACHE=[
  "./",
  "./index.html",
  "./favicon.svg?v=8.1.0",
  ...
  "./styles/edge-internet-v720.css?v=8.1.0",
  ...
  "./src/features/edge-internet-v720.js?v=8.1.0",
  "./src/features/edge-advanced-v730.js?v=8.1.0",
