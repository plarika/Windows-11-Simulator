...
await check("Real functions Explorer Settings V9.8.4 marker",async()=>await evaluate(`Win11RealFunctions?.step===34 && Win11RealFunctions.features.includes("explorer-multi-window") && Win11RealFunctions.features.includes("taskbar-system-integration") && Win11RealFunctions.features.includes("settings-profile-store") && Win11RealFunctions.features.includes("explorer-settings-store") && Win11RealFunctions.features.includes("explorer-settings-events") && Win11RealFunctions.features.includes("explorer-compact-view") && Win11RealFunctions.features.includes("explorer-open-to") && Win11RealFunctions.features.includes("explorer-delete-confirmation") && Win11RealFunctions.features.includes("explorer-filesystem-settings-bridge")`));
