...
await check("Explorer V9.1 hide extensions",async()=>await evaluate(`(()=>{const w=document.querySelector('.window[data-app="explorer"]'),n=[...w.querySelectorAll(".file,.file-row:not(.header)")].find(x=>x.dataset.v740Name==="alpha.txt"),label=n?.querySelector(".file-name")||n?.querySelector(".fname span:last-child");return n?.dataset.v740Name==="alpha.txt"&&label?.textContent==="alpha"&&Win11ExplorerFilesystem.getState().showExtensions===false&&Win11SettingsStore.get("explorer.showExtensions")===false})()`));
...
await check("Explorer V9.1 preferences reset",async()=>await evaluate(`(()=>{const s=Win11ExplorerFilesystem.getState();return s.showHidden===false&&s.showExtensions===true&&Win11SettingsStore.get("explorer.showHidden")===false&&Win11SettingsStore.get("explorer.showExtensions")===true&&Win11ExplorerFilesystem.getMetadata("C:/Documents/V74Audit","beta.txt","file").hidden===false})()`));
await check("Explorer Settings V9.8.4 bridge",async()=>await evaluate(`Win11ExplorerSettings?.version==="9.8.4"&&typeof Win11ExplorerSettings.apply==="function"&&typeof Win11ExplorerSettings.resolveInitialPath==="function"`));
await evaluate(`(()=>{globalThis.__v984ExplorerBefore=Win11SettingsStore.get("explorer");openApp("settings");state.settingsPage="explorer";const w=document.querySelector('.window[data-app="settings"]');if(w){w.querySelector(".win-body").innerHTML="";w.querySelector(".win-body").appendChild(renderApp("settings",w));}return true})()`); await wait(120);
await check("Explorer Settings V9.8.4 UI",async()=>await evaluate(`document.querySelectorAll('.window[data-app="settings"] [data-explorer-toggle-v984]').length===4&&document.querySelectorAll('.window[data-app="settings"] [data-explorer-open-v984]').length===2&&!!document.querySelector('.window[data-app="settings"] .settings-explorer-badge-v984')`));
await evaluate(`Win11SettingsStore.set("explorer.compactView",true,{source:"browser-audit-v984"});true`); await wait(80);
await check("Explorer V9.8.4 Compact View live apply",async()=>await evaluate(`(()=>{const w=document.querySelector('.window[data-app="explorer"]'),r=w?.querySelector(".explorer-v4")||w?.querySelector(".explorer-real");return Win11SettingsStore.get("explorer.compactView")===true&&r?.classList.contains("explorer-compact-v984")&&r?.dataset.explorerSettings==="9.8.4"})()`));
await evaluate(`Win11SettingsStore.set("explorer.compactView",false,{source:"browser-audit-v984"});true`); await wait(60);
await check("Explorer V9.8.4 Compact View disable",async()=>await evaluate(`(()=>{const w=document.querySelector('.window[data-app="explorer"]'),r=w?.querySelector(".explorer-v4")||w?.querySelector(".explorer-real");return !r?.classList.contains("explorer-compact-v984")})()`));
await evaluate(`(()=>{Win11SettingsStore.set("explorer.openTo","this-pc",{source:"browser-audit-v984"});const w=openAppNewWindow("explorer");globalThis.__v984ThisPcWindow=w.dataset.id;return true})()`); await wait(180);
await check("Explorer V9.8.4 openTo This PC",async()=>await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v984ThisPcWindow)+'"]');return !!w&&Win11ExplorerPro.currentVirtualPath(w)==="This PC"})()`));
await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v984ThisPcWindow)+'"]');if(w)closeWindow(w);Win11SettingsStore.set("explorer.openTo","home",{source:"browser-audit-v984"});globalThis.__v984HomeExpected=Win11ExplorerSettings.homePath;const h=openAppNewWindow("explorer");globalThis.__v984HomeWindow=h.dataset.id;return true})()`); await wait(180);
await check("Explorer V9.8.4 openTo Home Quick Access",async()=>await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v984HomeWindow)+'"]');return !!w&&Win11ExplorerPro.currentVirtualPath(w)===__v984HomeExpected&&__v984HomeExpected!=="This PC"})()`));
await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v984HomeWindow)+'"]');if(w)closeWindow(w);const main=document.querySelector('#window-layer > .window[data-app="explorer"]');main.__explorerNavigationV820.go("C:/Documents/V74Audit");ensureFolder("C:/Documents/V74Audit")["v984-delete.txt"]="DELETE_ME";main.__explorerProV740.forceRender();Win11SettingsStore.set("explorer.confirmDelete",true,{source:"browser-audit-v984"});return true})()`); await wait(140);
await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-app="explorer"]'),n=[...w.querySelectorAll(".file,.file-row:not(.header)")].find(x=>x.dataset.v740Name==="v984-delete.txt");n?.click();return !!n})()`); await wait(40);
await evaluate(`document.querySelector('#window-layer > .window[data-app="explorer"]').__explorerProV740.deleteSelection(false);true`); await wait(70);
await check("Explorer V9.8.4 delete confirmation blocks mutation",async()=>await evaluate(`document.querySelector("#system-dialog").classList.contains("open")&&document.querySelector("#system-dialog-title").textContent.includes("Reciclagem")&&ensureFolder("C:/Documents/V74Audit")["v984-delete.txt"]==="DELETE_ME"`));
await evaluate(`document.querySelector("#system-dialog-x")?.click();Win11SettingsStore.set("explorer.confirmDelete",false,{source:"browser-audit-v984"});true`); await wait(40);
await evaluate(`document.querySelector('#window-layer > .window[data-app="explorer"]').__explorerProV740.deleteSelection(false);true`); await wait(100);
await check("Explorer V9.8.4 delete confirmation bypass",async()=>await evaluate(`(()=>{const bin=ensureFolder("Recycle Bin"),entry=Object.values(bin).find(x=>x?.originalName==="v984-delete.txt"&&x?.originalPath==="C:/Documents/V74Audit");return !Object.prototype.hasOwnProperty.call(ensureFolder("C:/Documents/V74Audit"),"v984-delete.txt")&&!!entry&&!document.querySelector("#system-dialog").classList.contains("open")})()`));
await evaluate(`(()=>{const bin=ensureFolder("Recycle Bin");for(const [name,entry] of Object.entries(bin))if(entry?.originalName==="v984-delete.txt"&&entry?.originalPath==="C:/Documents/V74Audit")delete bin[name];Win11SettingsStore.update("explorer",__v984ExplorerBefore,{source:"browser-audit-v984-cleanup"});Win11ExplorerSettings.apply();for(const k of ["__v984ExplorerBefore","__v984ThisPcWindow","__v984HomeWindow","__v984HomeExpected"])delete globalThis[k];saveState();return true})()`); await wait(100);
await check("Explorer V9.8.4 cleanup restores profile",async()=>await evaluate(`Win11ExplorerSettings.state.compactView===false&&Win11ExplorerFilesystem.getState().showHidden===false&&Win11ExplorerFilesystem.getState().showExtensions===true`));
...
await evaluate(`(()=>{globalThis.__v7PngBefore=Win11DesktopIntegration.defaultAppFor("imagem.png");const c=document.createElement("canvas");c.width=16;c.height=16;const x=c.getContext("2d");x.fillStyle="#3366cc";x.fillRect(0,0,16,16);ensureFolder("C:/Pictures")["V7Audit.png"]=c.toDataURL("image/png");Win11DesktopIntegration.setDefaultApp(".png","paint");return true})()`);
...
await evaluate(`delete ensureFolder("C:/Pictures")["V7Audit.png"];delete ensureFolder("C:/Documents")["ShareV7.txt"];Win11DesktopIntegration.setDefaultApp(".png",__v7PngBefore||"photos");delete globalThis.__v7PngBefore;saveState();true`);
...
await check("Settings Default Apps V9.8.5 UI",async()=>await evaluate(`!!document.querySelector('.window[data-app="settings"] [data-default-apps-v985]') && document.querySelector('.window[data-app="settings"] [data-default-kind-v985=".png"]')?.querySelectorAll("option").length>=2 && document.querySelectorAll('.window[data-app="settings"] [data-default-kind-v985]').length===9`));
await evaluate(`(()=>{globalThis.__v985AppsBefore=Win11SettingsStore.get("apps");globalThis.__v985Executed=0;return true})()`);
await check("Apps Registry V9.8.5 bridges",async()=>await evaluate(`Win11AppRegistry?.version==="9.8.5"&&Win11FileAssociations?.version==="9.8.5"&&Win11ProtocolRegistry?.version==="9.8.5"&&Win11DefaultApps?.version==="9.8.5"&&Win11AppRegistry.list().length===5`));
await check("Apps Registry candidate allowlists",async()=>await evaluate(`(()=>{const html=Win11AppRegistry.candidatesForExtension(".html").map(x=>x.id),png=Win11AppRegistry.candidatesForExtension(".png").map(x=>x.id),pdf=Win11AppRegistry.candidatesForExtension(".pdf").map(x=>x.id);return html.includes("edge")&&html.includes("notepad")&&png.includes("photos")&&png.includes("paint")&&pdf.length===1&&pdf[0]==="edge"})()`));
await evaluate(`(()=>{const s=document.querySelector('.window[data-app="settings"] [data-default-kind-v985=".html"]');s.value="edge";s.dispatchEvent(new Event("change",{bubbles:true}));return true})()`); await wait(70);
await check("Default Apps UI commits HTML association",async()=>await evaluate(`Win11SettingsStore.get("apps.htmlApp")==="edge"&&state.fileAssociations[".html"]==="edge"&&Win11DesktopIntegration.defaultAppFor("audit.html")==="edge"`));
await evaluate(`(()=>{ensureFolder("C:/Documents")["V985Audit.html"]='<h1>Seguro</h1><script>globalThis.__v985Executed=99<\\/script><img src="https://example.com/remote.png">';return true})()`);
await evaluate(`(async()=>{await openFile("C:/Documents","V985Audit.html",ensureFolder("C:/Documents")["V985Audit.html"]);const w=[...document.querySelectorAll('.window[data-app="edge"]')].pop();globalThis.__v985HtmlEdgeWin=w?.dataset.id||null;return true})()`); await wait(120);
await check("Edge safe local HTML preview",async()=>await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v985HtmlEdgeWin||"")+'"]'),frame=w?.querySelector(".edge-local-html-v985"),address=w?.querySelector(".edge-real-address");return !!frame&&frame.getAttribute("sandbox")===""&&!frame.srcdoc.toLowerCase().includes("<script")&&!frame.srcdoc.includes("https://example.com/remote.png")&&address?.value.startsWith("file://virtual/")&&globalThis.__v985Executed===0})()`));
await evaluate(`Win11FileAssociations.set(".html","notepad",{source:"browser-audit-v985"});true`); await wait(40);
await evaluate(`(async()=>{await openFile("C:/Documents","V985Audit.html",ensureFolder("C:/Documents")["V985Audit.html"]);const w=[...document.querySelectorAll('.window[data-app="notepad"]')].pop();globalThis.__v985HtmlNotepadWin=w?.dataset.id||null;return true})()`); await wait(100);
await check("HTML association switches to Notepad",async()=>await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v985HtmlNotepadWin||"")+'"]');return Win11SettingsStore.get("apps.htmlApp")==="notepad"&&w?.querySelector("textarea")?.value.includes("<script>globalThis.__v985Executed=99")&&globalThis.__v985Executed===0})()`));
await evaluate(`(()=>{ensureFolder("C:/Documents")["V985Audit.pdf"]="%PDF-1.4\\n% virtual audit";return true})()`);
await evaluate(`(async()=>{await openFile("C:/Documents","V985Audit.pdf",ensureFolder("C:/Documents")["V985Audit.pdf"]);const w=[...document.querySelectorAll('.window[data-app="edge"]')].pop();globalThis.__v985PdfEdgeWin=w?.dataset.id||null;return true})()`); await wait(100);
await check("PDF default opens Edge local viewer",async()=>await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v985PdfEdgeWin||"")+'"]'),frame=w?.querySelector(".edge-local-pdf-v985");return Win11FileAssociations.get(".pdf")==="edge"&&!!frame&&frame.getAttribute("sandbox")===""})()`));
await check("Default Apps reject incompatible handlers",async()=>await evaluate(`(()=>{let file=false,proto=false,scheme=false;try{Win11FileAssociations.set(".pdf","notepad")}catch{file=true}try{Win11ProtocolRegistry.set("https","notepad")}catch{proto=true}try{Win11ProtocolRegistry.open("javascript:alert(1)")}catch{scheme=true}return file&&proto&&scheme})()`));
await evaluate(`Win11ProtocolRegistry.open("https://example.com/v985");true`); await wait(90);
await check("HTTPS protocol opens in Edge",async()=>await evaluate(`[...document.querySelectorAll('.window[data-app="edge"] .edge-v730')].some(e=>e.__edgeV730?.getCurrent()?.url==="https://example.com/v985")&&state.protocolAssociations.https==="edge"`));
await evaluate(`(()=>{const input=document.querySelector("#run-input");input.value="https://example.org/v985";executeRun();return true})()`); await wait(80);
await check("Run consumes Windows Shell HTTPS intent",async()=>await evaluate(`[...document.querySelectorAll('.window[data-app="edge"] .edge-v730')].some(e=>e.__edgeV730?.getCurrent()?.url==="https://example.org/v985")&&Win11Shell.getHistory(10).some(x=>x.source==="run"&&x.kind==="url"&&x.ok)`));
await evaluate(`(()=>{const out=document.createElement("div");runVirtualCommand("start https://example.net/v985",out);globalThis.__v985TerminalResult=out.textContent;return true})()`); await wait(80);
await check("Terminal start consumes Windows Shell intent",async()=>await evaluate(`__v985TerminalResult.includes("Intent virtual encaminhado pelo Windows Shell")&&[...document.querySelectorAll('.window[data-app="edge"] .edge-v730')].some(e=>e.__edgeV730?.getCurrent()?.url==="https://example.net/v985")&&Win11Shell.getHistory(10).some(x=>x.source==="terminal-start"&&x.kind==="url"&&x.ok)`));
await evaluate(`(()=>{for(const id of [__v985HtmlEdgeWin,__v985HtmlNotepadWin,__v985PdfEdgeWin]){if(!id)continue;const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(id)+'"]');if(w)closeWindow(w)}delete ensureFolder("C:/Documents")["V985Audit.html"];delete ensureFolder("C:/Documents")["V985Audit.pdf"];Win11SettingsStore.update("apps",__v985AppsBefore,{source:"browser-audit-v985-cleanup"});for(const k of ["__v985AppsBefore","__v985Executed","__v985HtmlEdgeWin","__v985HtmlNotepadWin","__v985PdfEdgeWin","__v985TerminalResult"])delete globalThis[k];saveState();return true})()`); await wait(100);
await check("Apps Defaults V9.8.5 cleanup restores profile",async()=>await evaluate(`Win11DesktopIntegration.defaultAppFor("teste.txt")===Win11DefaultApps.forFile("teste.txt")&&state.fileAssociations[".html"]===Win11DefaultApps.forFile("teste.html")&&state.protocolAssociations.https===Win11DefaultApps.forProtocol("https")`));
await check("Storage V9.8.6 bridge and capacity",async()=>await evaluate(`(()=>{const s=Win11Storage?.snapshot?.();return Win11Storage?.version==="9.8.6"&&s?.capacity===128*1024*1024*1024&&s.categories.length===9&&s.used>0&&s.free===Math.max(0,s.capacity-s.used)})()`));
await check("Storage V9.8.6 categories",async()=>await evaluate(`(()=>{const keys=Win11Storage.snapshot().categories.map(c=>c.key);return ["apps","documents","pictures","videos","music","downloads","temporary","recycle","other"].every(k=>keys.includes(k))&&Win11Storage.snapshot().categories.find(c=>c.key==="apps").bytes>0})()`));
await evaluate(`(()=>{globalThis.__v986StorageBefore=Win11SettingsStore.get("storage");state.settingsPage="storage";const w=document.querySelector('.window[data-app="settings"]');if(w){w.querySelector(".win-body").innerHTML="";w.querySelector(".win-body").appendChild(renderApp("settings",w));}return true})()`); await wait(120);
await check("Storage V9.8.6 Settings UI",async()=>await evaluate(`document.querySelectorAll('.window[data-app="settings"] [data-storage-category]').length===9&&document.querySelectorAll('.window[data-app="settings"] [data-storage-toggle-v986]').length===2&&!!document.querySelector('.window[data-app="settings"] [data-storage-clean-v986]')&&document.querySelector('.window[data-app="settings"] .storage-badge-v986')?.textContent.includes("V9.8.6")`));
await evaluate(`(()=>{globalThis.__v986FilesBefore=state.files;globalThis.__v986SaveStateBefore=globalThis.saveState;globalThis.saveState=()=>{};state.files={"C:/Temp":{"V986.tmp":"temporary-data"},"C:/Documents":{"keep.txt":"keep-data"},"Recycle Bin":{"audit-trash":{originalName:"trash.txt",originalPath:"C:/Documents",content:"trash-data",deletedAt:Date.now()}}};return true})()`);
await check("Storage V9.8.6 sandbox scan",async()=>await evaluate(`(()=>{const s=Win11Storage.snapshot(),t=s.categories.find(c=>c.key==="temporary"),d=s.categories.find(c=>c.key==="documents"),r=s.categories.find(c=>c.key==="recycle");return t.files===1&&t.bytes>0&&d.files===1&&d.bytes>0&&r.files===1&&r.bytes>0})()`));
await evaluate(`(async()=>{globalThis.__v986ManualCleanup=await Win11Storage.cleanup({temporary:true,recycleBin:false,source:"browser-audit-v986"});return true})()`); await wait(50);
await check("Storage V9.8.6 manual temp cleanup",async()=>await evaluate(`__v986ManualCleanup.temporary.files===1&&__v986ManualCleanup.freed>0&&Object.keys(ensureFolder("C:/Temp")).length===0&&ensureFolder("C:/Documents")["keep.txt"]==="keep-data"&&Object.keys(ensureFolder("Recycle Bin")).length===1`));
await evaluate(`(()=>{ensureFolder("C:/Temp")["Sense.tmp"]="sense-data";Win11SettingsStore.update("storage",{cleanupEnabled:true,recycleBinEnabled:false},{source:"browser-audit-v986"});return true})()`);
await evaluate(`(async()=>{globalThis.__v986SenseResult=await Win11Storage.runStorageSense({source:"browser-audit-v986-sense"});return true})()`); await wait(60);
await check("Storage V9.8.6 Storage Sense cleanup",async()=>await evaluate(`__v986SenseResult.ran===true&&__v986SenseResult.temporary.files===1&&__v986SenseResult.freed>0&&Object.keys(ensureFolder("C:/Temp")).length===0&&Object.keys(ensureFolder("Recycle Bin")).length===1`));
await evaluate(`(()=>{state.files=__v986FilesBefore;globalThis.saveState=__v986SaveStateBefore;Win11SettingsStore.update("storage",__v986StorageBefore,{source:"browser-audit-v986-cleanup"});globalThis.__v986RestoredStorage=structuredClone(__v986StorageBefore);for(const k of ["__v986StorageBefore","__v986FilesBefore","__v986SaveStateBefore","__v986ManualCleanup","__v986SenseResult"])delete globalThis[k];saveState();return true})()`); await wait(80);
await evaluate(`(()=>{const w=openAppNewWindow("explorer","This PC");globalThis.__v986ExplorerWin=w.dataset.id;return true})()`); await wait(160);
await check("Explorer consumes Storage V9.8.6 snapshot",async()=>await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v986ExplorerWin)+'"]'),summary=w?.querySelector(".thispc-storage-summary-v840"),drive=[...w?.querySelectorAll(".drive-card")||[]].find(x=>x.textContent.includes("Disco Local"));return !!summary&&summary.textContent.includes("128 GB")&&!!drive&&drive.textContent.includes("128 GB")})()`));
await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v986ExplorerWin)+'"]');if(w)closeWindow(w);delete globalThis.__v986ExplorerWin;return true})()`);
await check("Storage V9.8.6 cleanup restores profile",async()=>await evaluate(`Win11SettingsStore.get("storage.cleanupEnabled")===__v986RestoredStorage.cleanupEnabled&&Win11SettingsStore.get("storage.recycleBinEnabled")===__v986RestoredStorage.recycleBinEnabled&&typeof Win11Storage.snapshot().used==="number"`));
await evaluate(`delete globalThis.__v986RestoredStorage;true`);
await check("System Health V9.8.7 bridge",async()=>await evaluate(`Win11SystemHealth?.version==="9.8.7"&&typeof Win11SystemHealth.diagnose==="function"&&typeof Win11SystemHealth.reconcile==="function"&&typeof Win11SystemHealth.exportDiagnostics==="function"`));
await check("System Health V9.8.7 baseline",async()=>await evaluate(`(()=>{const d=Win11SystemHealth.diagnose({record:false,source:"browser-audit-v987"});return d.checks.length===10&&d.errors===0&&d.score>=90&&d.checks.find(x=>x.id==="integrity")?.status==="ok"&&d.checks.find(x=>x.id==="schema")?.status==="ok"&&d.checks.find(x=>x.id==="apps")?.status==="ok"&&d.checks.find(x=>x.id==="storage")?.status==="ok"})()`));
await evaluate(`(()=>{state.settingsPage="health";const w=document.querySelector('.window[data-app="settings"]');if(w){w.querySelector(".win-body").innerHTML="";w.querySelector(".win-body").appendChild(renderApp("settings",w));}return true})()`); await wait(120);
await check("System Health V9.8.7 Settings UI",async()=>await evaluate(`document.querySelectorAll('.window[data-app="settings"] [data-health-check]').length===10&&!!document.querySelector('.window[data-app="settings"] [data-health-reconcile-v987]')&&!!document.querySelector('.window[data-app="settings"] [data-health-export-v987]')&&document.querySelector('.window[data-app="settings"] .health-badge-v987')?.textContent.includes("V9.8.7")`));
await check("System Health V9.8.7 export is aggregate only",async()=>await evaluate(`(()=>{const x=Win11SystemHealth.exportDiagnostics(),raw=JSON.stringify(x);return x.kind==="win11-simulator-system-health"&&x.version==="9.8.7"&&Array.isArray(x.checks)&&!raw.includes("activeUserId")&&!raw.includes("state.files")&&!raw.includes("fileAssociations")})()`));
await evaluate(`(()=>{globalThis.__v987CanonicalBefore=JSON.stringify(Win11SettingsStore.exportConfig().data);globalThis.__v987RevisionBefore=Win11SettingsStore.metadata().revision;state.fileAssociations[".htm"]="paint";state.fileAssociations[".jpeg"]="notepad";return true})()`);
await check("System Health V9.8.7 detects bridge divergence",async()=>await evaluate(`(()=>{const d=Win11SystemHealth.diagnose({record:false,source:"browser-audit-v987-divergence"}),b=d.checks.find(x=>x.id==="bridges");return b?.status==="warn"&&b.repairable===true&&JSON.stringify(Win11SettingsStore.exportConfig().data)===__v987CanonicalBefore})()`));
await evaluate(`(async()=>{globalThis.__v987RepairResult=await Win11SystemHealth.reconcile({source:"browser-audit-v987-reconcile"});return true})()`); await wait(100);
await check("System Health V9.8.7 reconciles aliases without canonical mutation",async()=>await evaluate(`(()=>{const cfg=Win11SettingsStore.get("apps"),after=__v987RepairResult.after;return state.fileAssociations[".htm"]===cfg.htmlApp&&state.fileAssociations[".jpeg"]===cfg.jpgApp&&JSON.stringify(Win11SettingsStore.exportConfig().data)===__v987CanonicalBefore&&Win11SettingsStore.metadata().revision===__v987RevisionBefore&&after.errors===0&&after.checks.find(x=>x.id==="bridges")?.status==="ok"})()`));
await check("System Health V9.8.7 reconciliation event",async()=>await evaluate(`Win11SystemBus.getHistory("system-health:reconciled",10).some(e=>e.detail?.source==="browser-audit-v987-reconcile")&&Win11SystemBus.getHistory("settings:reconciled",10).some(e=>e.detail?.source==="system-health-v987"&&e.detail?.changed===true)`));
await check("Settings reconciliation is idempotent",async()=>await evaluate(`(()=>{const rev=Win11SettingsStore.metadata().revision,r=Win11SettingsStore.reconcileLegacy({source:"browser-audit-v987-idempotent"});return r.changed===false&&r.revision===rev&&Win11SettingsStore.metadata().revision===rev})()`));
await evaluate(`(()=>{for(let i=0;i<25;i++)Win11SystemHealth.diagnose({record:true,source:"browser-audit-v987-history"});return true})()`);
await check("System Health V9.8.7 history bounded",async()=>await evaluate(`Win11SystemHealth.getHistory(100).length===20&&Win11SystemHealth.last?.version==="9.8.7"`));
await evaluate(`(()=>{for(const k of ["__v987CanonicalBefore","__v987RevisionBefore","__v987RepairResult"])delete globalThis[k];return true})()`);
await check("Windows Shell V9.9.0 bridges",async()=>await evaluate(`Win11Shell?.version==="9.9.0"&&Win11AppLifecycle?.version==="9.9.0"&&typeof Win11Shell.open==="function"&&typeof Win11Shell.resolve==="function"`));
await check("Windows Shell V9.9.0 resolves deep links",async()=>await evaluate(`(()=>{const a=Win11Shell.resolve("ms-settings:storage"),b=Win11Shell.resolve("shell:Downloads"),c=Win11Shell.resolve("https://example.com/v990"),e=Win11Shell.resolve("app:calc");return a.kind==="settings"&&a.page==="storage"&&b.kind==="folder"&&b.path==="C:/Downloads"&&c.kind==="url"&&c.scheme==="https"&&e.kind==="app"&&e.appId==="calc"})()`));
await check("Windows Shell V9.9.0 rejects unsafe intents",async()=>await evaluate(`!Win11Shell.canOpen("javascript:alert(1)")&&!Win11Shell.canOpen("ms-settings:not-a-page")&&!Win11Shell.canOpen("C:/Documents/../outside.txt")`));
await evaluate(`(()=>{globalThis.__v990SettingsBefore=state.settingsPage;globalThis.__v990NotepadBefore={text:state.notepadText,file:structuredClone(state.notepadFile||null),ids:[...document.querySelectorAll('.window[data-app="notepad"]')].map(w=>w.dataset.id)};return true})()`);
await evaluate(`Win11Shell.open("ms-settings:storage",{source:"browser-audit-v990-settings"});true`); await wait(100);
await check("ms-settings deep link updates existing Settings window",async()=>await evaluate(`state.settingsPage==="storage"&&document.querySelector('.window[data-app="settings"] [data-settings="storage"]')?.classList.contains("active")&&!!document.querySelector('.window[data-app="settings"] [data-storage-clean-v986]')`));
await evaluate(`(()=>{globalThis.__v990FolderResult=Win11Shell.open("shell:Downloads",{source:"browser-audit-v990-folder",newWindow:true});return true})()`); await wait(140);
await check("shell folder intent opens explicit Explorer destination",async()=>await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v990FolderResult.windowId)+'"]');return __v990FolderResult.kind==="folder"&&!!w&&Win11ExplorerPro.currentVirtualPath(w)==="C:/Downloads"})()`));
await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v990FolderResult.windowId)+'"]');if(w)closeWindow(w);delete globalThis.__v990FolderResult;return true})()`); await wait(60);
await evaluate(`(()=>{globalThis.__v990CalcResult=Win11Shell.open("app:calc",{source:"browser-audit-v990-lifecycle",newWindow:true});return true})()`); await wait(100);
await check("App Lifecycle records launch",async()=>await evaluate(`Win11AppLifecycle.getHistory(20,"launched").some(e=>e.windowId===__v990CalcResult.windowId&&e.appId==="calc")&&Win11SystemBus.getHistory("app:launched",20).some(e=>e.detail?.windowId===__v990CalcResult.windowId)`));
await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v990CalcResult.windowId)+'"]');w?.querySelector(".min")?.click();return true})()`); await wait(70);
await check("App Lifecycle records minimize",async()=>await evaluate(`Win11AppLifecycle.getHistory(20,"minimized").some(e=>e.windowId===__v990CalcResult.windowId)`));
await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v990CalcResult.windowId)+'"]');if(!w)return false;w.classList.remove("hidden");w.dispatchEvent(new Event("pointerdown",{bubbles:true}));return true})()`); await wait(70);
await check("App Lifecycle records restore and activation",async()=>await evaluate(`Win11AppLifecycle.getHistory(30,"restored").some(e=>e.windowId===__v990CalcResult.windowId)&&Win11AppLifecycle.getHistory(30,"activated").some(e=>e.windowId===__v990CalcResult.windowId)`));
await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v990CalcResult.windowId)+'"]');w?.querySelector(".close")?.click();return true})()`); await wait(80);
await check("App Lifecycle records close",async()=>await evaluate(`Win11AppLifecycle.getHistory(30,"closed").some(e=>e.windowId===__v990CalcResult.windowId)&&!Win11AppLifecycle.getState(__v990CalcResult.windowId)`));
await evaluate(`delete globalThis.__v990CalcResult;true`);
await evaluate(`(async()=>{const folder=ensureFolder("C:/Documents");globalThis.__v990HadFile=Object.prototype.hasOwnProperty.call(folder,"V990Intent.txt");globalThis.__v990OldFile=folder["V990Intent.txt"];folder["V990Intent.txt"]="V9.9.0 intent audit";globalThis.__v990FileResult=await Win11Shell.open("C:/Documents/V990Intent.txt",{source:"browser-audit-v990-file"});return true})()`); await wait(100);
await check("Virtual file intent uses default application",async()=>await evaluate(`__v990FileResult.appId==="notepad"&&state.notepadText==="V9.9.0 intent audit"&&Win11DefaultApps.forFile("V990Intent.txt")==="notepad"`));
await check("Shell history redacts virtual filename",async()=>await evaluate(`!JSON.stringify(Win11Shell.getHistory(60)).includes("V990Intent.txt")&&Win11Shell.getHistory(60).length<=60`));
await evaluate(`(()=>{const folder=ensureFolder("C:/Documents");if(__v990HadFile)folder["V990Intent.txt"]=__v990OldFile;else delete folder["V990Intent.txt"];state.notepadText=__v990NotepadBefore.text;if(__v990NotepadBefore.file)state.notepadFile=__v990NotepadBefore.file;else delete state.notepadFile;for(const w of [...document.querySelectorAll('.window[data-app="notepad"]')])if(!__v990NotepadBefore.ids.includes(w.dataset.id))closeWindow(w);saveState();return true})()`);
await evaluate(`(()=>{const input=document.querySelector("#run-input");input.value="ms-settings:health";executeRun();return true})()`); await wait(80);
await check("Run consumes ms-settings intent",async()=>await evaluate(`state.settingsPage==="health"&&Win11Shell.getHistory(20).some(x=>x.source==="run"&&x.kind==="settings"&&x.page==="health"&&x.ok)`));
await evaluate(`(()=>{const out=document.createElement("div");runVirtualCommand("start ms-settings:storage",out);globalThis.__v990TerminalText=out.textContent;return true})()`); await wait(80);
await check("Terminal start consumes ms-settings intent",async()=>await evaluate(`__v990TerminalText.includes("Intent virtual encaminhado pelo Windows Shell")&&state.settingsPage==="storage"&&Win11Shell.getHistory(20).some(x=>x.source==="terminal-start"&&x.kind==="settings"&&x.ok)`));
await evaluate(`(()=>{const out=document.createElement("div");runPowerShellCommand("Start-Process ms-settings:defaultapps",out);globalThis.__v990PowerShellText=out.textContent;return true})()`); await wait(80);
await check("PowerShell Start-Process consumes shell intent",async()=>await evaluate(`__v990PowerShellText.includes("Intent virtual iniciado pelo Windows Shell")&&state.settingsPage==="apps"&&Win11Shell.getHistory(20).some(x=>x.source==="powershell-start-process"&&x.kind==="settings"&&x.ok)`));
await check("Shell and lifecycle histories stay bounded",async()=>await evaluate(`Win11Shell.getHistory(1000).length<=60&&Win11AppLifecycle.getHistory(1000).length<=100`));
await evaluate(`(()=>{Win11Shell.openSettings(__v990SettingsBefore||"system",{source:"browser-audit-v990-cleanup"});for(const k of ["__v990SettingsBefore","__v990NotepadBefore","__v990HadFile","__v990OldFile","__v990FileResult","__v990TerminalText","__v990PowerShellText"])delete globalThis[k];return true})()`); await wait(80);
await check("App Sessions V9.9.1 bridge and policies",async()=>await evaluate(`Win11AppSessions?.version==="9.9.1"&&Win11AppSessions.policy("settings").mode==="single"&&Win11AppSessions.policy("calc").mode==="multi"&&Win11AppSessions.policy("explorer").allowMultiple===true&&typeof Win11AppSessions.activate==="function"&&typeof Win11AppSessions.closeApp==="function"`));
await evaluate(`(()=>{globalThis.__v991SettingsPageBefore=state.settingsPage;const desktop=Number(state.currentDesktop)||0;const settings=[...document.querySelectorAll('#window-layer > .window[data-app="settings"]')].filter(w=>Number(w.dataset.desktop||0)===desktop);globalThis.__v991SettingsId=settings[0]?.dataset.id||null;globalThis.__v991SettingsCount=settings.length;globalThis.__v991CalcBefore=[...document.querySelectorAll('#window-layer > .window[data-app="calc"]')].map(w=>w.dataset.id);return true})()`);
await evaluate(`(()=>{globalThis.__v991SingleWindow=openAppNewWindow("settings");return true})()`); await wait(60);
await check("Single-instance policy reuses Settings window",async()=>await evaluate(`(()=>{const desktop=Number(state.currentDesktop)||0,settings=[...document.querySelectorAll('#window-layer > .window[data-app="settings"]')].filter(w=>Number(w.dataset.desktop||0)===desktop);return settings.length===__v991SettingsCount&&__v991SingleWindow?.dataset.id===__v991SettingsId&&Win11AppSessions.getHistory(10).some(x=>x.appId==="settings"&&x.action==="reused"&&x.requestedNewWindow===true)})()`));
await evaluate(`(()=>{const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v991SettingsId||"")+'"]');w?.querySelector(".min")?.click();return true})()`); await wait(60);
await evaluate(`(()=>{globalThis.__v991Restored=Win11AppSessions.activate("settings",{source:"browser-audit-v991-restore"});return true})()`); await wait(70);
await check("Session activation restores minimized singleton",async()=>await evaluate(`__v991Restored?.dataset.id===__v991SettingsId&&!__v991Restored.classList.contains("hidden")&&__v991Restored.classList.contains("focused")&&Win11AppSessions.getHistory(10).some(x=>x.source==="browser-audit-v991-restore"&&x.action==="reused")`));
await evaluate(`(()=>{globalThis.__v991CalcA=Win11AppSessions.openNew("calc",undefined,{source:"browser-audit-v991-multi-a"});globalThis.__v991CalcB=Win11AppSessions.openNew("calc",undefined,{source:"browser-audit-v991-multi-b"});return true})()`); await wait(100);
await check("Multi-instance policy creates distinct Calculator windows",async()=>await evaluate(`__v991CalcA?.dataset.id!==__v991CalcB?.dataset.id&&!__v991CalcBefore.includes(__v991CalcA.dataset.id)&&!__v991CalcBefore.includes(__v991CalcB.dataset.id)&&document.querySelectorAll('#window-layer > .window[data-app="calc"]').length>=__v991CalcBefore.length+2`));
await evaluate(`(()=>{__v991CalcA?.querySelector(".min")?.click();return true})()`); await wait(50);
await evaluate(`(()=>{globalThis.__v991ActivatedWindow=Win11AppSessions.activateWindow(__v991CalcA?.dataset.id,{source:"browser-audit-v991-window"});return true})()`); await wait(60);
await check("activateWindow restores and focuses exact session",async()=>await evaluate(`__v991ActivatedWindow?.dataset.id===__v991CalcA?.dataset.id&&!__v991ActivatedWindow.classList.contains("hidden")&&__v991ActivatedWindow.classList.contains("focused")&&Win11AppSessions.getHistory(10).some(x=>x.source==="browser-audit-v991-window"&&x.action==="activated-window")`));
await evaluate(`(()=>{focusWindow(__v991CalcB);globalThis.__v991ClosedOne=Win11AppSessions.closeApp("calc",{all:false,source:"browser-audit-v991-close"});return true})()`); await wait(70);
await check("closeApp closes only active session when all=false",async()=>await evaluate(`__v991ClosedOne===1&&!document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v991CalcB?.dataset.id||"")+'"]')&&!!document.querySelector('#window-layer > .window[data-id="'+CSS.escape(__v991CalcA?.dataset.id||"")+'"]')&&Win11SystemBus.getHistory("app-session:closed",10).some(e=>e.detail?.source==="browser-audit-v991-close"&&e.detail?.count===1)`));
await evaluate(`Win11Shell.openSettings("apps",{source:"browser-audit-v991-ui"});true`); await wait(110);
await check("App Sessions V9.9.1 Settings UI coexists with defaults",async()=>await evaluate(`!!document.querySelector('.window[data-app="settings"] [data-app-sessions-v991]')&&!!document.querySelector('.window[data-app="settings"] [data-default-apps-v985]')&&!!document.querySelector('.window[data-app="settings"] [data-session-app="settings"]')&&!!document.querySelector('.window[data-app="settings"] [data-session-activate="settings"]')`));
await check("App Sessions diagnostics reflect running windows",async()=>await evaluate(`(()=>{const d=Win11AppSessions.diagnostics(),s=Win11AppSessions.snapshot();return d.version==="9.9.1"&&d.windows===s.reduce((n,x)=>n+x.count,0)&&d.runningApps===s.length&&d.singlePolicies>0&&d.multiPolicies>0&&d.historyLimit===80})()`));
await evaluate(`(()=>{for(let i=0;i<85;i++)Win11AppSessions.activateWindow(__v991SettingsId,{source:"browser-audit-v991-history"});return true})()`); await wait(80);
await check("App Sessions V9.9.1 history bounded",async()=>await evaluate(`Win11AppSessions.getHistory(1000).length===80&&Win11AppSessions.getHistory(80)[0]?.source==="browser-audit-v991-history"`));
await evaluate(`(()=>{for(const id of [__v991CalcA?.dataset.id,__v991CalcB?.dataset.id]){if(!id||__v991CalcBefore.includes(id))continue;const w=document.querySelector('#window-layer > .window[data-id="'+CSS.escape(id)+'"]');if(w)closeWindow(w)}Win11Shell.openSettings(__v991SettingsPageBefore||"system",{source:"browser-audit-v991-cleanup"});for(const k of ["__v991SettingsPageBefore","__v991SettingsId","__v991SettingsCount","__v991CalcBefore","__v991SingleWindow","__v991Restored","__v991CalcA","__v991CalcB","__v991ActivatedWindow","__v991ClosedOne"])delete globalThis[k];return true})()`); await wait(80);
await check("Session Restore V9.9.2 bridge and defaults",async()=>await evaluate(`Win11SessionRestore?.version==="9.9.2"&&Win11SessionRestore.limits.maxWindows===24&&Win11SessionRestore.limits.maxPerAppDesktop===4&&typeof Win11SessionRestore.capture==="function"&&typeof Win11SessionRestore.restore==="function"`));
await evaluate(`(()=>{globalThis.__v992Before=structuredClone(state.appSessionRestoreV992);globalThis.__v992SettingsPage=state.settingsPage;globalThis.__v992NotepadText=state.notepadText;globalThis.__v992WindowIds=[...document.querySelectorAll("#window-layer > .window")].map(w=>w.dataset.id);globalThis.__v992HadPrivate=Object.prototype.hasOwnProperty.call(state.files,"C:/PrivateV992");globalThis.__v992PrivateOld=state.files["C:/PrivateV992"];state.files["C:/PrivateV992"]={};Win11SessionRestore.setEnabled(true,{source:"browser-audit-v992-enable"});return true})()`);
await evaluate(`(()=>{state.notepadText="SECRET_CONTENT_V992";globalThis.__v992Calc1=Win11AppSessions.openNew("calc",undefined,{source:"browser-audit-v992"});globalThis.__v992Calc2=Win11AppSessions.openNew("calc",undefined,{source:"browser-audit-v992"});globalThis.__v992ExplorerSafe=Win11AppSessions.openNew("explorer","C:/Downloads",{source:"browser-audit-v992"});globalThis.__v992ExplorerPrivate=Win11AppSessions.openNew("explorer","C:/PrivateV992",{source:"browser-audit-v992"});globalThis.__v992Notepad=Win11AppSessions.openNew("notepad",undefined,{source:"browser-audit-v992"});return true})()`); await wait(180);
await evaluate(`(()=>{globalThis.__v992Capture=Win11SessionRestore.capture({source:"browser-audit-v992-capture",force:true});globalThis.__v992Snapshot=structuredClone(state.appSessionRestoreV992);globalThis.__v992CalcCount=__v992Snapshot.sessions.filter(x=>x.appId==="calc").length;return true})()`);
await check("Session snapshot stores safe bounded metadata",async()=>await evaluate(`(()=>{const raw=JSON.stringify(__v992Snapshot),allowed=new Set(["appId","desktop","hidden","maximized","focused","order","hint"]);return __v992Capture.captured===true&&__v992Snapshot.sessions.length<=24&&__v992Snapshot.sessions.every(x=>Object.keys(x).every(k=>allowed.has(k)))&&!raw.includes("SECRET_CONTENT_V992")&&!raw.includes("PrivateV992")&&__v992Snapshot.sessions.some(x=>x.appId==="explorer"&&x.hint==="C:/Downloads")})()`));
await check("Session snapshot enforces per-app limit",async()=>await evaluate(`__v992Snapshot.sessions.filter(x=>x.appId==="calc").length<=4&&__v992Snapshot.sessions.filter(x=>x.appId==="explorer").length<=4`));
await evaluate(`(()=>{for(const id of [__v992Calc1?.dataset.id,__v992Calc2?.dataset.id,__v992ExplorerSafe?.dataset.id,__v992ExplorerPrivate?.dataset.id,__v992Notepad?.dataset.id]){const w=id?document.querySelector('#window-layer > .window[data-id="'+CSS.escape(id)+'"]'):null;if(w)closeWindow(w)}return true})()`); await wait(100);
await evaluate(`(async()=>{globalThis.__v992Restore=await Win11SessionRestore.restore({source:"browser-audit-v992-restore"});return true})()`); await wait(180);
await check("Session Restore recreates missing sessions without exceeding snapshot",async()=>await evaluate(`__v992Restore.restored===true&&__v992Restore.count===__v992Snapshot.sessions.length&&document.querySelectorAll('#window-layer > .window[data-app="calc"]').length>=__v992CalcCount&&Win11SystemBus.getHistory("session-restore:restored",20).some(e=>e.detail?.source==="browser-audit-v992-restore")`));
await evaluate(`(()=>{const s=state.appSessionRestoreV992;globalThis.__v992SavedAt=s.savedAt;s.savedAt=Date.now()-Win11SessionRestore.limits.maxAgeMs-1000;return true})()`);
await evaluate(`(async()=>{globalThis.__v992Stale=await Win11SessionRestore.restore({source:"browser-audit-v992-stale"});state.appSessionRestoreV992.savedAt=__v992SavedAt;return true})()`);
await check("Session Restore refuses stale snapshots",async()=>await evaluate(`__v992Stale.restored===false&&__v992Stale.reason==="stale"`));
await evaluate(`(()=>{window.dispatchEvent(new CustomEvent("win11-session-saving",{detail:{reason:"browser-audit-v992"}}));return true})()`); await wait(80);
await check("Session saving hook captures before profile persistence",async()=>await evaluate(`Win11SystemBus.getHistory("session-restore:captured",20).some(e=>e.detail?.source==="session-saving-browser-audit-v992")`));
await evaluate(`(()=>{state.settingsPage="accounts";const w=document.querySelector('.window[data-app="settings"]');if(w){w.querySelector(".win-body").innerHTML="";w.querySelector(".win-body").appendChild(renderApp("settings",w));}return true})()`); await wait(120);
await check("Session Restore V9.9.2 Accounts UI",async()=>await evaluate(`!!document.querySelector('.window[data-app="settings"] [data-session-restore-v992]')&&!!document.querySelector('.window[data-app="settings"] [data-session-restore-toggle-v992]')&&!!document.querySelector('.window[data-app="settings"] [data-session-restore-save-v992]')&&!!document.querySelector('.window[data-app="settings"] [data-session-restore-now-v992]')`));
await evaluate(`(()=>{window.dispatchEvent(new CustomEvent("win11-session-start",{detail:{reason:"browser-audit-v992"}}));return true})()`); await wait(180);
await check("Session start hook reconciles saved apps",async()=>await evaluate(`Win11SystemBus.getHistory("session-restore:restored",20).some(e=>e.detail?.source==="session-start-browser-audit-v992")`));
await evaluate(`(()=>{const originals=new Set(__v992WindowIds);for(const w of [...document.querySelectorAll("#window-layer > .window")])if(!originals.has(w.dataset.id))closeWindow(w);if(__v992HadPrivate)state.files["C:/PrivateV992"]=__v992PrivateOld;else delete state.files["C:/PrivateV992"];state.notepadText=__v992NotepadText;document.querySelectorAll('#window-layer > .window[data-app="notepad"] textarea').forEach(ta=>ta.value=state.notepadText||"");state.appSessionRestoreV992=__v992Before;state.settingsPage=__v992SettingsPage;saveState();const sw=document.querySelector('.window[data-app="settings"]');if(sw){sw.querySelector(".win-body").innerHTML="";sw.querySelector(".win-body").appendChild(renderApp("settings",sw));}for(const k of ["__v992Before","__v992SettingsPage","__v992NotepadText","__v992WindowIds","__v992HadPrivate","__v992PrivateOld","__v992Calc1","__v992Calc2","__v992ExplorerSafe","__v992ExplorerPrivate","__v992Notepad","__v992Capture","__v992Snapshot","__v992CalcCount","__v992Restore","__v992SavedAt","__v992Stale"])delete globalThis[k];return true})()`); await wait(100);
...
await check("Taskbar System V9.8.3 bridge",async()=>await evaluate(`Win11TaskbarSystem?.version==="9.8.3"&&typeof Win11TaskbarSystem.apply==="function"&&typeof Win11TaskbarSystem.showDesktop==="function"&&document.querySelector("#app").dataset.taskbarSystem==="9.8.3"`));
await check("Taskbar V9.8.3 Settings UI controls",async()=>await evaluate(`document.querySelectorAll('.window[data-app="settings"] [data-setting-toggle-v982="taskbar.autoHide"]').length===1&&document.querySelectorAll('.window[data-app="settings"] [data-setting-toggle-v982="taskbar.showDesktop"]').length===1&&document.querySelectorAll('.window[data-app="settings"] [data-setting-toggle-v982="taskbar.showSeconds"]').length===1`));
await evaluate(`(()=>{globalThis.__v983TaskbarBefore=Win11SettingsStore.get("taskbar");Win11SettingsStore.update("taskbar",{autoHide:true,showDesktop:true,showSeconds:true},{source:"browser-audit-v983"});return true})()`); await wait(1150);
await check("Taskbar V9.8.3 auto-hide activates",async()=>await evaluate(`document.querySelector("#app").classList.contains("taskbar-autohide-v983")&&document.querySelector("#app").classList.contains("taskbar-auto-hidden-v983")&&!document.querySelector("#taskbar-reveal-v983").hidden`));
await check("Taskbar V9.8.3 reveal API",async()=>await evaluate(`Win11TaskbarSystem.reveal()&&!document.querySelector("#app").classList.contains("taskbar-auto-hidden-v983")`));
await wait(1100);
await check("Taskbar V9.8.3 seconds clock",async()=>await evaluate(`/^\\d{2}:\\d{2}:\\d{2}$/.test(document.querySelector("#clock").textContent.trim())&&Win11TaskbarSystem.state.showSeconds===true`));
await evaluate(`(()=>{const wins=[...document.querySelectorAll('#window-layer > .window')].filter(w=>Number(w.dataset.desktop||0)===(Number(state.currentDesktop)||0)&&!w.classList.contains("hidden"));globalThis.__v983DesktopIds=wins.map(w=>w.dataset.id);Win11TaskbarSystem.showDesktop();return true})()`); await wait(60);
await check("Taskbar V9.8.3 Show Desktop minimizes current desktop",async()=>await evaluate(`__v983DesktopIds.length>0&&__v983DesktopIds.every(id=>document.querySelector('#window-layer > .window[data-id="'+CSS.escape(id)+'"]')?.classList.contains("hidden"))&&Win11TaskbarSystem.state.desktopShowing===true`));
await evaluate(`Win11TaskbarSystem.showDesktop();true`); await wait(60);
await check("Taskbar V9.8.3 Show Desktop restores windows",async()=>await evaluate(`__v983DesktopIds.every(id=>!document.querySelector('#window-layer > .window[data-id="'+CSS.escape(id)+'"]')?.classList.contains("hidden"))&&Win11TaskbarSystem.state.desktopShowing===false`));
await evaluate(`(()=>{Win11TaskbarSystem.showDesktop();Win11SettingsStore.set("taskbar.showDesktop",false,{source:"browser-audit-v983"});return true})()`); await wait(80);
await check("Taskbar V9.8.3 disabling Show Desktop restores windows",async()=>await evaluate(`__v983DesktopIds.every(id=>!document.querySelector('#window-layer > .window[data-id="'+CSS.escape(id)+'"]')?.classList.contains("hidden"))&&Win11TaskbarSystem.state.desktopShowing===false&&document.querySelector("#show-desktop-v983").hidden===true`));
await evaluate(`Win11SettingsStore.set("taskbar.showSeconds",false,{source:"browser-audit-v983"});true`); await wait(1100);
await check("Taskbar V9.8.3 clock returns to minutes",async()=>await evaluate(`/^\\d{2}:\\d{2}$/.test(document.querySelector("#clock").textContent.trim())`));
await evaluate(`(()=>{Win11SettingsStore.update("taskbar",__v983TaskbarBefore,{source:"browser-audit-v983-cleanup"});Win11TaskbarSystem.apply();delete globalThis.__v983TaskbarBefore;delete globalThis.__v983DesktopIds;return true})()`); await wait(80);
await check("Taskbar V9.8.3 cleanup restores profile",async()=>await evaluate(`document.querySelector("#show-desktop-v983").hidden===!Win11SettingsStore.get("taskbar.showDesktop")&&Win11TaskbarSystem.state.autoHide===Win11SettingsStore.get("taskbar.autoHide")`));
...
await evaluate(`Win11SettingsStore.set("appearance.themeMode","light",{source:"browser-audit-resmon-v9841"});true`);
await check("Resource Monitor V9.8.4.1 light contrast",async()=>await waitFor(async()=>await evaluate(`(()=>{
  if(document.querySelector("#app").classList.contains("theme-dark"))return false;
  ...
  if(!body||!title||!tab)return false;
  const rgb=s=>{const m=String(s||"").match(/rgba?\\((\\d+)[, ]+(\\d+)[, ]+(\\d+)/);return m?[+m[1],+m[2],+m[3]]:null};
  const lum=c=>{if(!c)return 0;const a=c.map(v=>{v/=255;return v<=.04045?v/12.92:Math.pow((v+.055)/1.055,2.4)});return .2126*a[0]+.7152*a[1]+.0722*a[2]};
  const cr=(fg,bg)=>{const a=lum(rgb(fg)),b=lum(rgb(bg)),hi=Math.max(a,b),lo=Math.min(a,b);return (hi+.05)/(lo+.05)};
...
await wait(220);
await evaluate(`document.querySelector('#window-layer > .window[data-app="notepad"] [data-saveas]').click();true`);
await wait(120);
...
await check("Notepad real file controls",async()=>await evaluate(`!!document.querySelector('#window-layer > .window[data-app="notepad"] [data-open-device]') && !!document.querySelector('#window-layer > .window[data-app="notepad"] [data-save-device]')`));
...
await check("Real functions Session Restore V9.9.2 marker",async()=>await evaluate(`Win11RealFunctions?.step===40 && Win11RealFunctions.features.includes("app-session-manager") && Win11RealFunctions.features.includes("session-restore") && Win11RealFunctions.features.includes("restartable-apps") && Win11RealFunctions.features.includes("per-profile-session-snapshot") && Win11RealFunctions.features.includes("safe-session-metadata") && Win11RealFunctions.features.includes("bounded-session-snapshot") && Win11RealFunctions.features.includes("session-start-restore") && Win11RealFunctions.features.includes("session-saving-hook") && Win11RealFunctions.features.includes("accounts-session-restore-ui")`));
...
await check("PWA cache populated",async()=>await evaluate(`(async()=>{for(let i=0;i<25;i++){const keys=await caches.keys();if(keys.includes("win11-simulator-v9.9.2"))return true;await new Promise(x=>setTimeout(x,100))}return false})()`));
...
await evaluate(`(()=>{sessionStorage.setItem("__audit-v985-png-before",Win11FileAssociations.get(".png")||"photos");Win11FileAssociations.set(".png","paint",{source:"browser-audit-refresh"});closeOverlays();state.notepadText="USER_ONE_REFRESH";saveState();return true})()`);
await send("Emulation.clearDeviceMetricsOverride");
await send("Page.reload",{ignoreCache:true});
await waitFor(async()=>await evaluate(`(()=>{const lock=document.querySelector("#lock");return document.readyState==="complete"&&typeof Win11SettingsStore==="object"&&typeof Win11FileAssociations==="object"&&typeof Win11Storage==="object"&&typeof Win11SessionManager==="object"&&Win11SessionManager.activeUserId===${JSON.stringify(user1Id)}&&lock?.classList.contains("hidden")&&getComputedStyle(lock).display==="none"})()`),7000,100);
...
await check("file association survives refresh",async()=>await evaluate(`state.fileAssociations?.[".png"]==="paint"&&Win11SettingsStore.get("apps.pngApp")==="paint"&&Win11DesktopIntegration.defaultAppFor("after-refresh.png")==="paint"`));
...
await evaluate(`(()=>{const previous=sessionStorage.getItem("__audit-v985-png-before")||"photos";Win11FileAssociations.set(".png",previous,{source:"browser-audit-refresh-cleanup"});sessionStorage.removeItem("__audit-v985-png-before");return true})()`);
