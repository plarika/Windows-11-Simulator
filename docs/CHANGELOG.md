...
Este ficheiro preserva o histórico detalhado das versões anteriores do Windows 11 Simulator.

## V10.x

### V10.3 — Window Manager
- contrato V10 para lifecycle de janelas, Snap Layouts, ambientes virtuais e placements
- diagnóstico e reconciliação automática do estado de janelas

### V10.2 — Desktop / Taskbar
- contratos V10 para Desktop, Taskbar e pins do Start
- self-healing de botões órfãos/duplicados e diagnóstico de integridade

### V10.1 — Boot / Recovery
- boot por fases, timeouts, boot-loop guard e plano central de recuperação

### V10.0 — Foundation
- Platform Kernel, module registry, lifecycle, health e diagnostics

## Histórico V6.x → V9.9.7
