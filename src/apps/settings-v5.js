...
function renderSettingsPageV5(box,page){
  ...
  else if(page==="apps"){box.innerHTML=`<h1>Aplicações</h1><div class="sys-grid"><div class="sys-card clickable" data-open-v5="store"><strong>🛍️ Aplicações instaladas</strong><p>Microsoft Store virtual.</p></div><div class="sys-card clickable" data-open-v5="optionalfeatures"><strong>🧩 Funcionalidades opcionais</strong><p>Gerir componentes do Windows virtual.</p></div><div class="sys-card"><strong>Associações e protocolos</strong><p>Geridos abaixo pelo Registry V9.8.5 e pelo Settings Core.</p></div><div class="sys-card"><strong>Arranque</strong><p>Gerir no Gestor de Tarefas.</p></div></div>`}
