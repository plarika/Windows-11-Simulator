...
check(
  index.includes("./favicon.svg?v=7.5.0"),
...
check(index.includes("./src/features/real-files-v640.js?v=7.5.0"), "Real file bridge loaded");
check(index.includes("./styles/real-files-v640.css?v=7.5.0"), "Real file bridge styles loaded");
...
check(index.includes("./src/features/real-clipboard-v650.js?v=7.5.0"), "Real clipboard bridge loaded");
check(index.includes("./styles/real-clipboard-v650.css?v=7.5.0"), "Real clipboard styles loaded");
...
check(index.includes("./src/features/real-content-v660.js?v=7.5.0"), "Real content module loaded");
check(index.includes("./styles/real-content-v660.css?v=7.5.0"), "Real content styles loaded");
...
check(index.includes("./manifest.webmanifest?v=7.5.0"), "PWA manifest loaded");
check(index.includes("./src/features/real-platform-v660.js?v=7.5.0"), "Real platform module loaded");
...
check(index.includes("./src/features/local-accounts-v670.js?v=7.5.0"), "Session module loaded");
check(index.includes("./styles/local-accounts-v670.css?v=7.5.0"), "Session styles loaded");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("local-accounts-v670.js?v=7.5.0"), "Session module precached by service worker");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("auth-crypto-v673.js?v=7.5.0"), "Auth worker precached by service worker");
...
check(index.includes("./src/features/real-device-tools-v680.js?v=7.5.0"), "Real device tools module loaded");
check(index.includes("./styles/real-device-tools-v680.css?v=7.5.0"), "Real device tools styles loaded");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("real-device-tools-v680.js?v=7.5.0"), "Real device tools precached");
...
check(index.includes("./src/features/desktop-integration-v700.js?v=7.5.0"), "Desktop integration module loaded");
check(index.includes("./styles/desktop-integration-v700.css?v=7.5.0"), "Desktop integration styles loaded");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("desktop-integration-v700.js?v=7.5.0"), "Desktop integration precached");
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("desktop-integration-v700.css?v=7.5.0"), "Desktop integration CSS precached");
const realMounts=readFileSync(resolve(root, "src/features/real-folder-mounts-v710.js"), "utf8");
check(index.includes("./src/features/real-folder-mounts-v710.js?v=7.5.0"), "Real folder mounts module loaded");
check(index.includes("./styles/real-folder-mounts-v710.css?v=7.5.0"), "Real folder mounts styles loaded");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("real-folder-mounts-v710.js?v=7.5.0"), "Real folder mounts precached");
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("real-folder-mounts-v710.css?v=7.5.0"), "Real folder mounts CSS precached");
const edgeInternet=readFileSync(resolve(root, "src/features/edge-internet-v720.js"), "utf8");
check(index.includes("./src/features/edge-internet-v720.js?v=7.5.0"), "Edge Internet module loaded");
check(index.includes("./styles/edge-internet-v720.css?v=7.5.0"), "Edge Internet styles loaded");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("edge-internet-v720.js?v=7.5.0"), "Edge Internet module precached");
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("edge-internet-v720.css?v=7.5.0"), "Edge Internet CSS precached");
const edgeAdvanced=readFileSync(resolve(root, "src/features/edge-advanced-v730.js"), "utf8");
check(index.includes("./src/features/edge-advanced-v730.js?v=7.5.0"), "Edge Advanced module loaded");
check(index.includes("./styles/edge-advanced-v730.css?v=7.5.0"), "Edge Advanced styles loaded");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("edge-advanced-v730.js?v=7.5.0"), "Edge Advanced module precached");
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("edge-advanced-v730.css?v=7.5.0"), "Edge Advanced CSS precached");
const explorerPro=readFileSync(resolve(root, "src/features/explorer-pro-v740.js"), "utf8");
check(index.includes("./src/features/explorer-pro-v740.js?v=7.5.0"), "Explorer Pro module loaded");
check(index.includes("./styles/explorer-pro-v740.css?v=7.5.0"), "Explorer Pro styles loaded");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("explorer-pro-v740.js?v=7.5.0"), "Explorer Pro module precached");
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("explorer-pro-v740.css?v=7.5.0"), "Explorer Pro CSS precached");
const windowManager=readFileSync(resolve(root, "src/features/window-manager-v750.js"), "utf8");
check(index.includes("./src/features/window-manager-v750.js?v=7.5.0"), "Window Manager V7.5 module loaded");
check(index.includes("./styles/window-manager-v750.css?v=7.5.0"), "Window Manager V7.5 styles loaded");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("window-manager-v750.js?v=7.5.0"), "Window Manager V7.5 module precached");
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("window-manager-v750.css?v=7.5.0"), "Window Manager V7.5 CSS precached");
