...
check(index.includes("./src/features/settings-core-v981.js?v=9.8.2"), "Settings Core V9.8.1 module loaded through V9.8.2 cache key");
check(index.includes("./src/features/settings-personalization-v982.js?v=9.8.2"), "Settings Personalization V9.8.2 module loaded");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("settings-core-v981.js?v=9.8.2"), "Settings Core V9.8.1 module precached with V9.8.2 cache key");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("settings-personalization-v982.js?v=9.8.2"), "Settings Personalization V9.8.2 module precached");
