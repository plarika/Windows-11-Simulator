...
check(index.includes("./src/features/explorer-pro-v740.js?v=9.4.0"), "Explorer Pro module loaded");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("explorer-pro-v740.js?v=9.4.0"), "Explorer Pro module precached");
...
check(index.includes("./src/features/explorer-history-v940.js?v=9.4.0"), "Explorer History V9.4 module loaded");
...
check(explorerPro.includes("originalName:name") && explorerPro.includes("entry.originalName||name"), "Recycle Bin preserves original file name");
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("explorer-history-v940.js?v=9.4.0"), "Explorer History V9.4 module precached");
