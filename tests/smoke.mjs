...
check(index.includes("./src/features/edge-advanced-v730.js?v=8.1.2"), "Edge Advanced module loaded");
...
check(index.includes("./src/features/explorer-pro-v740.js?v=8.2.1"), "Explorer Pro module loaded");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("explorer-pro-v740.js?v=8.2.1"), "Explorer Pro module precached");
...
check(index.includes("./src/features/explorer-navigation-v820.js?v=8.2.1"), "Explorer Navigation V8.2 module loaded");
check(index.includes("./styles/explorer-navigation-v820.css?v=8.2.0"), "Explorer Navigation V8.2 styles loaded");
check(explorerNavigation.includes('version:"8.2.1"'), "Explorer Navigation V8.2 bridge present");
...
check(explorerNavigation.includes("explorerNavigationV821") && explorerNavigation.includes("lastSession"), "Explorer tab session persists in profile state");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("explorer-navigation-v820.js?v=8.2.1"), "Explorer Navigation V8.2 module precached");
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("explorer-navigation-v820.css?v=8.2.0"), "Explorer Navigation V8.2 CSS precached");
