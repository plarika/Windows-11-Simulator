...
check(edgeInternet.includes('url.searchParams.set("newwindow","0")'), "Google embedded results request same-frame navigation");
...
check(edgeInternet.includes("YOUTUBE_HOSTS") && edgeInternet.includes("youtubeInternalFor") && edgeInternet.includes("youtubeEmbedFor"), "YouTube URL parser/embed bridge present");
...
check(edgeInternet.includes('if(value.startsWith("edge://youtube"))return value') && edgeInternet.includes("www.youtube-nocookie.com"), "YouTube internal routes are preserved and use privacy-enhanced embed");
...
check(edgeInternet.includes('"shorts"') && edgeInternet.includes('"youtu.be"') && edgeInternet.includes('"edge://youtube/watch?"'), "YouTube Shorts and short-link normalization present");
check(edgeInternet.includes('YOUTUBE_EMBED_HOST="www.youtube-nocookie.com"') && edgeInternet.includes("/embed/videoseries"), "YouTube privacy-enhanced video/playlist embed routes present");
check(edgeAdvanced.includes("function renderYouTube") && edgeAdvanced.includes("edge-youtube-player-v996"), "Edge Advanced internal YouTube player page present");
check(edgeAdvanced.includes('data-edge-shortcut="edge://youtube"') && edgeAdvanced.includes("Google, YouTube, Ouvir Música"), "Edge home exposes Google and YouTube shortcuts");
check(edgeAdvanced.includes("navegação no mesmo conteúdo quando permitida"), "Edge Google same-frame compatibility disclosure present");
