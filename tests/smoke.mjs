...
check(explorerNavigation.includes('version:"8.3.0"'), "Explorer Navigation V8.3 bridge present");
...
check(index.includes("./styles/explorer-sidebar-v870.css?v=9.0.0"), "Explorer Sidebar V8.7 styles loaded");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("explorer-sidebar-v870.css?v=9.0.0"), "Explorer Sidebar V8.7 CSS precached");
