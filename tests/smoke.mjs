...
check(index.includes("./src/features/edge-internet-v720.js?v=8.1.1"), "Edge Internet module loaded");
check(index.includes("./styles/edge-internet-v720.css?v=8.1.1"), "Edge Internet styles loaded");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("edge-internet-v720.js?v=8.1.1"), "Edge Internet module precached");
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("edge-internet-v720.css?v=8.1.1"), "Edge Internet CSS precached");
const edgeAdvanced=readFileSync(resolve(root, "src/features/edge-advanced-v730.js"), "utf8");
check(index.includes("./src/features/edge-advanced-v730.js?v=8.1.1"), "Edge Advanced module loaded");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("edge-advanced-v730.js?v=8.1.1"), "Edge Advanced module precached");
