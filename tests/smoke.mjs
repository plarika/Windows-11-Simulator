...
check(index.includes("./src/features/explorer-navigation-v820.js?v=8.2.0"), "Explorer Navigation V8.2 module loaded");
check(index.includes("./styles/explorer-navigation-v820.css?v=8.2.0"), "Explorer Navigation V8.2 styles loaded");
check(explorerNavigation.includes('version:"8.2.0"'), "Explorer Navigation V8.2 bridge present");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("explorer-navigation-v820.js?v=8.2.0"), "Explorer Navigation V8.2 module precached");
