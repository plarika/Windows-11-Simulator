...
check(index.includes("./src/features/settings-core-v981.js?v=9.8.1"), "Settings Core V9.8.1 module loaded");
...
check(readFileSync(resolve(root, "service-worker.js"), "utf8").includes("settings-core-v981.js?v=9.8.1"), "Settings Core V9.8.1 module precached");
